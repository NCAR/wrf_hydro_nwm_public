...
void _nhdLakeMap_mpp_tonodeout_light_C(int *gto,int gnlinksl,int *linkid,int nlinksl,int *tmp_kk,
				       int *ind, int *gToNodeOut)
{
  map<int,int> hash;
  map<int,int>::iterator it;
...
void nhdLakeMap_mpp_tonodeout_light_C(int *gto,int gnlinksl,int *linkid,int nlinksl,int *kk,
				      int *ind, int *gToNodeOut)
  {
    int tmp_kk = *kk;
    _nhdLakeMap_mpp_tonodeout_light_C(gto, gnlinksl, linkid, nlinksl, &tmp_kk,
				      ind, gToNodeOut);
    *kk = tmp_kk;
  }
