...
$(SOLVER)_wrf : wrf.o
	$(RANLIB) libwrflib.a
	$(LD) -o wrf.exe $(LDFLAGS) wrf.o libwrflib.a $(LIB) -L../phys/RTLAND/Run -lrtland

$(SOLVER)_wrf_ESMFApp : wrf_ESMFApp.o
	$(RANLIB) libwrflib.a
	$(LD) -o wrf_ESMFApp.exe $(LDFLAGS) wrf_ESMFApp.o libwrflib.a $(LIB)
...
convert_em : convert_em.o
	$(RANLIB) libwrflib.a
	$(FC) -o convert_em.exe $(LDFLAGS) convert_em.o libwrflib.a $(LIB)
...
wrf_ESMFApp.o:  ../share/module_wrf_top.o
