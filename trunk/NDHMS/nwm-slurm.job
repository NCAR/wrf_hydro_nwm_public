...
#SBATCH -J nwm-assim          # -J, --job-name=jobname      name of job
...
#SBATCH --ntasks-per-node=24 # (24) --ntasks-per-node=n     number of tasks to invoke on each node
#SBATCH -N 32                # (32) -N, --nodes=N           number of nodes on which to run (N = min[-max])
