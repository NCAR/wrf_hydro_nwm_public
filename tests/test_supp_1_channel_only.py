...
from tests.utilities import wait_on_file, ONE_HOUR, TEN_MINUTES
...
#     print('\n')
#
#     # candidate_exe = output_dir / 'run_candidate' / 'WrfHydroSim_collected.pkl'
#     # wait_on_file(candidate_exe, TEN_MINUTES, "test_run_candidate() timed out waiting for candidate run", True)
#
...
#     wait_on_file(candidate_channel_only_run_file, ONE_HOUR, "Channel-Only andidate run object not found, skipping test")
#
...
#         output_dir / 'channel_only_candidate_run' / 'WrfHydroSim_collected.pkl'
#
#     wait_on_file(candidate_channel_only_sim_file, ONE_HOUR,
#                  "Channel-Only Candidate sim object not found, skipping test")
#     wait_on_file(candidate_channel_only_collected_file, ONE_HOUR,
